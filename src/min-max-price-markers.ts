...
import { isOhlcData, isValueData, merge } from './helpers';
...
export class MinMaxPriceMarkers implements ISeriesPrimitive<Time> {
  ...
  private _options: IMinMaxPriceMarkersOptions = defaultOptions;

  // --------------------------------------------------
  public constructor(opts?: {
    options?: DeepPartial<IMinMaxPriceMarkersOptions>;
  }) {
    this._options = opts?.options
      ? merge(defaultOptions, opts.options)
      : defaultOptions;
  }
